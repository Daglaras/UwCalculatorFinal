    ...
    if cursor.fetchone()[0] == 0:
        ...
        cursor.executescript('''
            INSERT INTO series (type_id, name, code, a, b, x, uf1, uf2, e, f, e_narrow, f_narrow) VALUES 
                (1, 'PR320', '320', 83, 51, 4.5, 7.2, 7.2, 99, 99, NULL, NULL),
                (1, 'PR45', '45', 83, 62.5, 4.5, 5.9, 5.9, 103, 103, NULL, NULL),
                (1, 'IQ34', '34', 62, 47, 4.5, 5.9, 3.5, 75, 64, 45, 34),
                (1, 'IQ460', '460', 80, 64, 4.5, 5.9, 3.5, 91, 80, 61, 50),
                (1, 'IQ580', '580', 96, 80, 4.5, 5.9, 3.5, 107, 96, 77, 66);
        ''')
